<section class="container px-4 mx-auto">
    <div class="sm:flex sm:items-center sm:justify-center">
        <h1 class="px-4 mt-5 text-5xl font-normal text-center text-gray-500 dark:text-gray-400">Teacher List</h1>
    </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-50 dark:bg-gray-800">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                    <button class="flex items-center gap-x-2">
                                        <span>Cluster Name Assigned</span>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                ...
                                <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                    <div class="inline-flex items-center gap-x-3">
                                        ...
                                        <div class="flex items-center gap-x-2">
                                            ...
                                            <div>
                                                <h2 class="font-medium text-gray-800 dark:text-white ">Teacher 1</h2>
                                                <p class="text-sm font-normal text-gray-600 dark:text-gray-400">@teacher1</p>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                    <div class="inline-flex items-center gap-x-3">
                                        ...
                                        <div class="flex items-center gap-x-2">
                                            <img alt="ecommerce" class="object-cover w-10 h-10 rounded-full" src="{{ asset('images/profile.png') }}">
                                            <div>
                                                <h2 class="font-medium text-gray-800 dark:text-white ">Teacher 5</h2>
                                                <p class="text-sm font-normal text-gray-600 dark:text-gray-400">@teacher5</p>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">Cluster C</td>
                            ...
                            <tr>
                                <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                    <div class="inline-flex items-center gap-x-3">
                                        ...
                                        <div class="flex items-center gap-x-2">
                                            <img alt="ecommerce" class="object-cover w-10 h-10 rounded-full" src="{{ asset('images/profile.png') }}">
                                            <div>
                                                <h2 class="font-medium text-gray-800 dark:text-white ">Teacher 3</h2>
                                                <p class="text-sm font-normal text-gray-600 dark:text-gray-400">@teacher3</p>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">Cluster F</td>
                            ...
                            <tr>
                                <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                    <div class="inline-flex items-center gap-x-3">
                                        ...
                                        <div class="flex items-center gap-x-2">
                                            <img alt="ecommerce" class="object-cover w-10 h-10 rounded-full" src="{{ asset('images/profile.png') }}">
                                            <div>
                                                <h2 class="font-medium text-gray-800 dark:text-white ">Teacher 2</h2>
                                                <p class="text-sm font-normal text-gray-600 dark:text-gray-400">@teacher2</p>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">Cluster B</td>
                            ...
                            <tr>
                                <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                    <div class="inline-flex items-center gap-x-3">
                                        ...
                                        <div class="flex items-center gap-x-2">
                                            <img alt="ecommerce" class="object-cover w-10 h-10 rounded-full" src="{{ asset('images/profile.png') }}">
                                            <div>
                                                <h2 class="font-medium text-gray-800 dark:text-white ">Teacher 4</h2>
                                                <p class="text-sm font-normal text-gray-600 dark:text-gray-400">@teacher4</p>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">Cluster D</td>
        ...
        <x-slot name="content">
            <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                ...
                <div class="flex gap-3 flex-wrap">
                    ...
                    <div class="relative flex-grow-3">
                        <input type="text" class="pr-3 peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-700 bg-white border rounded-lg dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 outline-none" placeholder="Teacher ID No" />
                        <label for="email" class="pl-3 absolute left-0 -top-2 text-gray-600 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-4 peer-focus:text-white peer-focus:text-sm">Teacher ID No:</label>
                    </div>
                    <div class="relative flex-grow-3">
                    ...
                    <div>
                        <h1 class="pt-2 text-gray-300 text-base">Teacher Picture</h1>
