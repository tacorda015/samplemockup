<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        ...
                        <img alt="ecommerce" class="block h-9 w-auto" src="{{ asset('images/cvsu-logo.png') }}">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    {{-- <x-nav-link href="{{ route('studentgroup.index') }}" :active="request()->routeIs('studentgroup.index')">
                        {{ __('List of Student in Group') }}
                    </x-nav-link> --}}
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            {{-- <x-responsive-nav-link href="{{ route('virtual.index') }}" :active="request()->routeIs('virtual.index')">
                {{ __('Virtual') }}
            </x-responsive-nav-link> --}}
            <x-responsive-nav-link href="{{ route('student.list.index') }}" :active="request()->routeIs('student.list.index')">
                {{ __('StudentList') }}
            </x-responsive-nav-link>
            {{-- <x-responsive-nav-link href="{{ route('teacher.list.index') }}" :active="request()->routeIs('teacher.list.index')">
                {{ __('TeacherList') }}
            </x-responsive-nav-link> --}}
            <x-responsive-nav-link href="{{ route('location.index') }}" :active="request()->routeIs('location.index')">
                {{ __('Location') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link href="{{ route('slocation.index') }}" :active="request()->routeIs('slocation.index')">
                {{ __('Location') }}
            </x-responsive-nav-link>
