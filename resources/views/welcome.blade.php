      ...
      <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
        <div class="pl-4 flex items-center">
          <a class="flex items-center align-middle" href="#">
            ...
            <img alt="ecommerce" class="object-cover w-auto h-20 text-white" src="{{ asset('images/cvsu-logo.png') }}">
            <h2 class="px-3 mt-2 text-3xl">NSTP Registration and Student Portal</h2>
          </a>
        </div>
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-white p-4 lg:p-0 z-20" id="nav-content">
          <ul class="list-reset lg:flex justify-end flex-1 items-center">
            <li class="mr-2">
              <a class="inline-block text-white bg-gray-700 px-5 py-3 rounded-full font-bold no-underline" href="#">Home</a>
            </li>
            <li class="mr-2">
              <a class="inline-block text-white bg-gray-700 px-5 py-3 rounded-full no-underline hover:text-gray-800 hover:text-underline" href="#">About</a>
            </li>
            <li class="mr-2">
              <a class="inline-block text-white bg-gray-700 px-5 py-3 rounded-full no-underline hover:text-gray-800 hover:text-underline" href="#">Contact Us</a>
            </li>
            <li>
                @if (Route::has('login'))
                <div class="p-3 text-right">
                    @auth
                        <a href="{{ url('/dashboard') }}" class="bg-gray-700 px-5 py-3 rounded-full font-semibold text-white hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Dashboard</a>
                    @else
                        <a href="{{ route('login') }}" class="bg-gray-700 px-5 py-3 rounded-full font-semibold text-white hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Log in</a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="bg-gray-700 px-5 py-3 rounded-full ml-4 font-semibold text-white hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Register</a>
                        @endif
                    @endauth
                </div>
            @endif
    ...
    <div class="pt-32">
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="flex flex-col w-full md:w-3/5 justify-center items-start text-center md:text-left">
          ...
          <p class="leading-normal text-xl mb-3">
            CvSU-CCAT Campus offered two components 
          </p>
          <h2 class="my-2 text-xl font-bold leading-tight">
            Reserved Officers Training Corps (ROTC) Program
          </h2>
          <h2 class="my-2 text-xl font-bold leading-tight">
            Civic Welfare Training Service (CWTS) Program
          </h2>
        </div>
        <!--Right Col-->
        ...
        <div class="flex flex-wrap">
          <div class="w-5/6 sm:w-1/2 p-6">
            <h3 class="text-3xl text-gray-800 font-bold leading-none mb-3">
                What is ROTC in NSTP?
            </h3>
            <p class="text-gray-600 mb-8">
                Reserve Officers Training Corps (ROTC) Refers to the program component designed to provide military training in order to motivate,
                train, organize and mobilize students for national defense preparedness.<br/><br>
                The ROTC under the NSTP shall instill patriotism, moral virtues, respect for rights of civilians, and adherence to the Constitution, 
                among others. Citizenship training shall be given emphasis in all three (3) program components.
              <br />
            </p>
          </div>
          <div class="w-full sm:w-1/2 p-6">
            <img alt="ecommerce" class=" w-full h-auto rounded-xl " src="{{ asset('images/rotc.jpg') }}">
          </div>
        </div>
        <div class="flex flex-wrap flex-col-reverse sm:flex-row">
          <div class="w-full sm:w-1/2 p-6 mt-6">
            <img alt="ecommerce" class=" w-full h-auto rounded-xl " src="{{ asset('images/cwts.jpg') }}">
          </div>
          <div class="w-full sm:w-1/2 p-6 mt-6">
            <div class="align-middle">
              <h3 class="text-3xl text-gray-800 font-bold leading-none mb-3">
                What is CWTS in NSTP?
              </h3>
              <p class="text-gray-600 mb-8">
                The Civic Welfare Training Service (CWTS) is one of three components of the National Service Training Program, 
                a civic education and defense preparedness program for higher and vocational education students in the Philippines.
                <br />
                ...
                Special attention is paid to the value of bibliometric and scientometric tools to support the evaluation and management of scientific research.
                <br />
              </p>
            </div>
          </div>
                    ...
                    <div class="mt-6 space-y-8 md:mt-8">
                        <p class="flex items-start -mx-2">
                            ...
                            <span class="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">
                                General Trias Drive 4106 Rosario, Philippines Calabarzon 
                            </span>
                        </p>
                        ...
                        <p class="flex items-start -mx-2">
                            ...
                            <span class="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">(046) 437 7776</span>
                        </p>
                        ...
                        <p class="flex items-start -mx-2">
                            ...
                            <span class="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">cvsu-rosario.edu.ph</span>
                        </p>
                    </div>
                    ...
                    <div
                        ...
                        <form class="mt-6">
                            <div class="flex-1">
                                ...
                                <input type="text" placeholder="Eduardo Tacorda" class="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                            </div>
    
                            <div class="flex-1 mt-6">
                                <label class="block mb-2 text-sm text-gray-600 dark:text-gray-200">Email address</label>
                                <input type="email" placeholder="eduardotacorda@example.com" class="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                            </div>
        ...
        <div class="w-full flex flex-col md:flex-row py-6">
          <div class="flex-1 mb-6 text-black">
            <a class="text-pink-600 no-underline hover:no-underline font-bold text-2xl lg:text-4xl" href="#">
              <!--Icon from: http://www.potlabicons.com/ -->
              <img alt="ecommerce" class="object-cover w-auto h-20 text-white" src="{{ asset('images/cvsu-logo.png') }}">
            <h2 class="px-3 mt-2 text-xl">NSTP Registration and Student Portal</h2>
            </a>
          </div>
          <div class="flex-1">
